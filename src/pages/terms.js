  ...
  return (
    <Layout>
      <div className="container mx-auto py-8">
        ...
        <div className="mb-8">
          <h5 className="text-xl font-bold mb-4">General Conditions of use</h5>
          <p className="mb-4">
            BEFORE USING THIS WEBSITE, PLEASE READ OUR TERMS OF USE SET OUT
            BELOW. BY USING THIS WEB SITE, YOU AGREE TO BE BOUND BY THESE TERMS
            OF USE. SOTURN COMPANY ORGANIZERS, HEREON REFERRED TO AS “WE”,
            RESERVES THE RIGHT TO REVISE THE TERMS OF USE AT ANY TIME WITHOUT
            NOTICE AND, BY USING THIS WEBSITE, SUBSEQUENT TO THE REVISION OF THE
            TERMS OF USE, YOU AGREE TO BE BOUND BY SUCH CHANGES. IF YOU FIND THE
            TERMS OF USE TO BE UNACCEPTABLE, YOU MUST IMMEDIATELY TERMINATE YOUR
            USE OF THIS WEBSITE.
          </p>
        </div>
        <div className="mb-8">
          ...
          <p className="mb-4">
            ...
            completely independent of this website. We make no representation or
            warranty as to the accuracy, completeness or authenticity of the
          ...
          <p className="mb-4">
            ...
            inappropriate or offensive. We cannot guarantee that a search will
          ...
          <p className="mb-4">
            ...
            this website and constitute the entire agreement with respect to
            your access to and use of this website. Any provision of these Terms
            of Use which is determined by a court of competent jurisdiction to
            be unenforceable in any jurisdiction shall be severable from these
